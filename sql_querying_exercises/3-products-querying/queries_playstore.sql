...
SELECT * FROM app_name WHERE id = '1880';
...
ELECT app_name, reviews FROM analytics ORDER BY reviews DESC LIMIT 5; 
...
SELECT app_name, rating FROM analytics WHERE rating < 3.0 AND reviews >= 10000;
...
ORDER BY proportion DESC LIMIT 5;
